  ...
  return (
    <div className="bg-black-secondary w-full">
      <div className="max-w-7xl m-auto px-5 py-20 flex flex-col gap-8">
        <div className="flex flex-col gap-1" data-aos="fade-left" data-aos-duration="1600">
        ...
        <div className="flex flex-col gap-5 md:flex-row">
          {step.map((item) => (
            <div key={item.id} className="shadow-xl bg-[#0B3A4F] rounded-xl p-7 flex flex-col gap-2" data-aos="fade-left" data-aos-duration="1600">
