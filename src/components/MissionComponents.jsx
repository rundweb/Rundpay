...
const MissionComponents = () => {
  ...
  return (
    <div className="max-w-7xl m-auto w-full p-5 flex flex-col gap-10 items-center">
      <div className="flex flex-col gap-2 text-center" data-aos="fade-up" data-aos-duration="1300">
      ...
      <div className="flex flex-wrap justify-around text-center gap-4 md:gap-20" data-aos="fade-up" data-aos-duration="1300">
        {mission.map((item) => (
      ...
      <h1 className="font-semibold text-black-secondary" data-aos="fade-up" data-aos-duration="1300">CHOSSE PLAN :</h1>
      <div className="flex flex-col gap-10 w-full md:flex-row items-center justify-center">
        <div className="bg-gray-100 h-56 lg:h-60 rounded-xl shadow-lg p-10 flex flex-col justify-between max-w-md w-full" data-aos="zoom-in" data-aos-duration="1300">
        ...
        <div className="bg-card bg-cover h-56 lg:h-60 rounded-xl shadow-lg p-10 flex flex-col justify-between max-w-md w-full" data-aos="zoom-in" data-aos-duration="1300">
