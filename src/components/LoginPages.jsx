      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center justify-center gap-2">
            ...
            <p className="text-sm text-black-secondary/90">Remember me</p>
          </div>
          <div>
            <a href="" className="text-sm text-black-secondary/90">
              Forgot password
            </a>
          </div>
        </div>
        ...
        <div className="w-full flex items-center justify-center">
          <div className="text-black-secondary tracking-wide text-sm flex items-center justify-center gap-1">
            ...
            <div className="font-semibold cursor-pointer" onClick={click}>Register</div>
          </div>
        </div>
      </div>
    </div>
