    ...
    <div className="p-5 max-w-7xl w-full m-auto">
      <div className="bg-black-secondary rounded-3xl px-5 py-8 flex flex-col gap-5 md:flex-row md:px-14 md:py-14 lg:px-20 lg:py-20">
        ...
        <div className="flex flex-col items-center gap-4 w-full md:flex-row lg:w-2/5">
          <a href="" className="bg-blue-primary w-full text-center font-semibold text-sm py-3 text-white rounded-lg lg:px-5 lg:py-4">Get Started Now</a>
          <a href="" className="border-[1px] border-blue-primary w-full text-center py-3 rounded-lg text-blue-primary font-semibold text-sm lg:px5 lg:py-4">Learn More </a>
        </div>
      </div>
    </div>
  );
